  ...
  public: {
    Tables: {
      ...
      user_folder_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_folder_files_file_id_fkey"
            columns: ["file_id"]
            isOneToOne: false
            referencedRelation: "files"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_folder_files_folder_id_fkey"
            columns: ["folder_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      search_files_by_entity: {
        Args: { _entity_value: string; _limit?: number; _user_id: string }
        Returns: {
          ai_summary: string
          entities: Json
          expiry_date: string
